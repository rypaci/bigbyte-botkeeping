...
<html lang="en">
    <head>
        ...
        <title>POS Entry Access Verification | Sheyan Water Refilling Station</title>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md" style="font-family: unset; font-size: 60px;">
                    <h5>POS Entry Access Verification</h5>
                </div>
                <div class="row">
                    <div class="col-md-12 form-timein">
                        {!! Form::open(array('url' => 'pos-entry-access-verified','method'=>'post')) !!}
                        <div class="row">
                            <div class="col-sm-12">
                                <label>QR Code:</label>
