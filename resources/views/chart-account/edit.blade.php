        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
                <div class="form-group {{ $errors->has('account_type_id') ? 'has-error' : ''}}">
                    {!! Form::label('account_type_id', 'Main Account', ['class' => 'control-label']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{ $errors->has('sub_account_type_id') ? 'has-error' : ''}}">
                    ...
                    {!! Form::select('sub_account_type_id', $subaccounttypes_option, null, ['class' => 'form-control']) !!}
            ...
            <div class="col-sm-6 col-sub-account @if(count($subaccounts_option) == 0) {{'hidden'}} @endif">
                <div class="form-group {{ $errors->has('parent_account_id') ? 'has-error' : ''}}">
                    ...
                    {!! Form::select('parent_account_id', $subaccounts_option, null, ['class' => 'form-control']) !!}
