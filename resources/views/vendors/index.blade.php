		...
		<table class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					...
					<th>S.No</th><th> Name / Company </th><th class="individual"> Individual? </th><th class="status">Inventory Active/Inactive</th><th class="actions">Actions</th>
				</tr>
			</thead>
			<tbody>
			{{-- */$x=0;/* --}}
