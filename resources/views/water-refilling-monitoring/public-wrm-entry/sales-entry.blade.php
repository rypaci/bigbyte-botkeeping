...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ url('wrm-assign-shifting') }}"> Switch Assigned</a>
        </div>
    ...
    <section class="content">
        ...
        {!! Form::open(array('url' => 'wrm-save-entry','method'=>'POST')) !!}
...
@include('water-refilling-monitoring.public-wrm-entry.form-script')   
<script>
