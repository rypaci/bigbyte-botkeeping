<script>
    ...
    $('#prod_ajax').autocomplete({
        source: '{{ url("wrm-product-autosuggest") }}',
        minLength: 2,
    });

    $('#cust_ajax').autocomplete({
        source: '{{ url("wrm-find-customer-autosuggest") }}',
        minLength: 3
    });
    ...
    $('.btn-search, .customer-search_by_id').on('click', function(){
        ...
        $.get('{{url("wrm-find-customer")}}', request, function(datacust){
    ...
    $('.btn-enter').on('click', function(){
        ...
        $.get('{{url("wrm-find-product")}}', request, function(data){
